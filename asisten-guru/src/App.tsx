    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <motion.div
          ...
          className="absolute left-0 top-0 flex h-full w-72 max-w-[80vw] flex-col border-r border-white/40 bg-emerald-soft/95 shadow-glass-lg pt-[env(safe-area-inset-top)]"
          role="dialog"
